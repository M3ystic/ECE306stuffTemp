...
//void go_autonomous(void){
//   switch (task2) {
//       case 0: // Go forward for 1 second
//           strncpy(display_line[0], BL_Start ,10);
//           P6OUT |= LCD_BACKLITE; // Initial Value = Low / Off
//           if (counter2 < 16) { // Assuming 200ms intervals
//               straight();
//           } else {
//               task2++;        // Move to the next task
...
//           if (counter2 < 2) { // 800ms duration for a right turn
//                   turn_right();
//           } else {
//               task2++;
//               counter2 = 0; // Reset counter
...
//           break;
//
//       case 3: // Stop for 400ms
//           if (counter2 < 1) { // 400ms intervals
//                       stop();
//           } else {
//               task2++;
//               counter2 = 0; // Reset counter
...
//           break;
//
//       case 4: // Go forward for another 1 second
//           if (counter2 < 27) { // 200ms intervals
//                       straight();
//           } else {
//               task2++;
//               counter2 = 0; // Reset counter
...
//
//       case 5: // Second turn
//           if (counter2 < 2) { // 800ms duration for a turn
//                       turn_right();
//           } else {
//               task2++;
//               counter2 = 0; // Reset counter
...
//           break;
//
//       case 6: // Continue going straight
//           if (counter2 < 1) { // 400ms intervals
//                        stop();
//                      //  SAC3DAT = 1800;
//            } else {
...
//            }
//            break;
//       case 7: // Continue going straight
//           if (counter2 < 10) { // 400ms intervals
//               straight();
//           } else {
//               task2++;
//               counter2 = 0; // Reset counter
...
//           break;
//
//       case 8: // Forward till detection
//              straight();
//              if (ADC_LEFT_DETECT > (MIDDLELINE/4) || ADC_RIGHT_DETECT > (MIDDLELINE/4)) { // Update thresholds if necessary
//                  strncpy(display_line[0], Intercept ,10);
//                  stop();
//                  task2++;
//                  counter2 = 0;
...
//           break;
//
//       case 10: // Turn action with counter
//           strncpy(display_line[0], BL_Turn ,10);
//           if (counter2 < 2) { // Adjust the counter threshold for timing
//                           turn_left();
//           } else {
//               stop();
//               task2++;
...
//           break;
//
//       case 12: // Follow the circle
//
//           while (ALWAYS) {
//               Display_Process();                 // Update Display
//               if (counter2 > 20) { // Adjust the counter threshold for timing
//                   strncpy(display_line[0], BL_Circle ,10);
//                   counter2 = 0;
//                   TB1CCTL2 &= ~CCIE;
//               }
