...
void Init_timer_B0(void)
{
    ...
    TB0CCR1 = TB0CCR1_10MS;  // Set CCR1 for 20ms (not used)
...
__interrupt void Timer0_B0_ISR(void)
{
    ...
    {
        timechanged += 2; // Increment timechanged by 2
        if (timechanged > 9998)    // 999.8 seconds
        {
            timechanged = 0; // Reset timechanged if it exceeds 9998
        }
    }
    ...
    switch (__even_in_range(TB0IV, 14))
    {
        ...
        case 2: // CCR1 interrupt (not used)
            ...
            if (DAC_data >= DAC_LIMIT)
            {
                ...
                DAC_data -= 10;  // Decrease DAC data for voltage to slowly increase
        ...
        case 4: // CCR2 interrupt for debounce logic
            ...
            TB0CCR2 += TB0CCR2_250MS; // Add 250ms offset for next debounce cycle
            break;
